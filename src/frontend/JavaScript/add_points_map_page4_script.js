$(document).ready(function(){
    $('#howMuchDepthButton1').click(function(event){
        ...
        for(var i=0;i<$('#inputDepthAddedStation1').val();i++){
            ...
            '<div><label for='+strDepth+'>Depth</label><input type="number" step=".00001" class="form-control" id='+strDepth+' name='+strDepth+' placeholder=Depth></div>'+
            '<div><label for='+strSalinity+'>Salinity</label><input type="number" step=".00001" class="form-control" id='+strSalinity+' name='+strSalinity+' placeholder=Salinity></div>'+
            '<div><label for='+strDoc+'>DOC</label><input type="number" step=".00001" class="form-control" id='+strDoc+' name='+strDoc+' placeholder=DOC></div>'+
            '</div>');
        }
